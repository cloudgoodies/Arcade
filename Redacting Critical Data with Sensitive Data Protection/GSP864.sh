...
echo "${BG_GREEN}${BLACK}${BOLD} Inspecting String Data... ${RESET}"
...
echo "${BG_GREEN}${BLACK}${BOLD} Inspecting File Data... ${RESET}"
...
echo "${BG_YELLOW}${BLACK}${BOLD} De-identifying Data... ${RESET}"
...
echo "${BG_YELLOW}${BLACK}${BOLD} Redacting Sensitive Data... ${RESET}"
...
echo "${GREEN}${BLACK}${BOLD} 🎉 Congratulations For Completing The Lab !!! 🎉 ${RESET}"
