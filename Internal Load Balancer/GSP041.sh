...
BLUE=$(tput setaf 33)         # Bright Blue
MAGENTA=$(tput setaf 201)     # Bright Magenta
CYAN=$(tput setaf 51)         # Bright Cyan
WHITE=$(tput setaf 15)        # Bright White

BG_BLACK=$(tput setab 0)
BG_RED=$(tput setab 196)      # Bright Red Background
BG_GREEN=$(tput setab 46)     # Bright Green Background
BG_YELLOW=$(tput setab 226)   # Bright Yellow Background
BG_BLUE=$(tput setab 33)      # Bright Blue Background
BG_MAGENTA=$(tput setab 201)  # Bright Magenta Background
BG_CYAN=$(tput setab 51)      # Bright Cyan Background
BG_WHITE=$(tput setab 15)     # Bright White Background
