...
echo "${CYAN}${BOLD}Starting${RESET}" "${BLUE}${BOLD}Execution${RESET}"
...
echo "${MAGENTA}${BOLD}🎉 Congratulations 🎉${RESET}" "${WHITE}${BOLD}on${RESET}" "${GREEN}${BOLD}completing the Lab! 🚀${RESET}"
