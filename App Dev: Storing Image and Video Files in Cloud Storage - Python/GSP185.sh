...
BG_LBLUE=`tput setab 12`
BG_LRED=`tput setab 9`
BG_LGREEN=`tput setab 10`
BG_LYELLOW=`tput setab 11`
BG_LMAGENTA=`tput setab 13`
BG_LCYAN=`tput setab 14`
BG_LWHITE=`tput setab 15`

BOLD=`tput bold`
RESET=`tput sgr0`
#----------------------------------------------------start--------------------------------------------------#

echo "${BG_LBLUE}${BOLD}Starting Execution${RESET}"
...
echo "${BG_LRED}${BOLD}Congratulations For Completing The Lab !!!${RESET}"
