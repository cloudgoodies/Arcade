...
echo
echo "${CYAN_TEXT}${BOLD_TEXT} Starting Executing ....${RESET_FORMAT}"
echo
...
echo
echo "${GREEN_TEXT}${BOLD_TEXT}===  Congratulstion to complete this Lab!! and Subscribe Cloudgoodies for more video ==${RESET_FORMAT}"
