...
if [ -z "$REGION" ]; then
  echo "${GREEN_TEXT}${BOLD_TEXT}⚠️  No default region found!${RESET_FORMAT}"
  echo "${GREEN_TEXT}${BOLD_TEXT}💡 Please specify your preferred region for App Engine deployment:${RESET_FORMAT}"
...
echo "${MAGENTA_TEXT}${BOLD_TEXT}💖 Conngratulation to Complete this Lab!! 👇${RESET_FORMAT}"
