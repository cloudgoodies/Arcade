...
# ------------------ ASK FOR ZONE ------------------
echo "${GREEN_TEXT}${BOLD}Enter zone (e.g., us-central1-a):${RESET}"
read ZONE
export ZONE

echo "${GREEN_TEXT}${BOLD}Creating Blue & Green servers...${RESET}"
...
echo "${GREEN_TEXT}${BOLD}Creating Firewall Rule...${RESET}"
...
# ------------------ CREATE TEST VM ------------------
echo "${GREEN_TEXT}${BOLD}Creating test-vm...${RESET}"
...
echo "${GREEN_TEXT}${BOLD}Creating Service Account & Keys...${RESET}"
...
echo "${GREEN_TEXT}${BOLD}Configuring Green Server...${RESET}"
...
echo "${GREEN_TEXT}${BOLD_TEXT}  CONGRATULATION  LAB COMPLETED THIS  SUCCESSFULLY!! and more video Subscribe cloudgoodies...          ${RESET_FORMAT}"
echo
