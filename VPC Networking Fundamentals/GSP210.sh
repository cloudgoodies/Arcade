...
echo -e "${YELLOW}${BOLD}         Starting Execution....            ${RESET}"
...
echo
echo -e "${YELLOW}${BOLD}  Congratulation to Complete this Labs!! and for more video   Subscribe To Cloudgoodies Labs   ${RESET}"
echo
